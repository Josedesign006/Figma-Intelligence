...
exports.avatarKnowledge = void 0;
exports.avatarKnowledge = {
    description: "User representation | Identity thumbnail | Profile image display",
    stateSpecifications: [
        {
            state: "Image Loaded",
    ...
    accessibilitySpec: {
        intro: "Avatars convey user identity and must be accessible to screen readers with meaningful alternative text and proper roles.",
        requirements: [
