...
exports.navbarKnowledge = void 0;
exports.navbarKnowledge = {
    description: "Top-level horizontal navigation bar | Site-wide header and branding | AppBar/Header pattern",
    stateSpecifications: [
        {
            state: "Default",
    ...
    accessibilitySpec: {
        intro: "The navbar is typically the first interactive region users encounter. Proper landmark roles, skip links, and keyboard navigation are essential for an accessible experience.",
        requirements: [
