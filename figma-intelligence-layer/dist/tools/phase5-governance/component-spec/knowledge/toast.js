...
exports.toastKnowledge = void 0;
exports.toastKnowledge = {
    description: "Transient notification | Status feedback message | Auto-dismissing alert",
    stateSpecifications: [
    ...
    accessibilitySpec: {
        intro: "Toasts must announce their content to screen readers without stealing focus from the user's current task. They rely on ARIA live regions to push announcements into the screen reader queue.",
        requirements: [
