...
exports.sliderKnowledge = void 0;
exports.sliderKnowledge = {
    description: "Continuous value selector | Range input control | Numeric value adjuster",
    stateSpecifications: [
        {
            state: "Default",
    ...
    accessibilitySpec: {
        intro: "Sliders must communicate their value, range, and orientation to assistive technology. Full keyboard control is required.",
        requirements: [
