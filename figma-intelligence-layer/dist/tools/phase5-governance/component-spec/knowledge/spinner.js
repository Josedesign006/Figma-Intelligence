...
exports.spinnerKnowledge = void 0;
exports.spinnerKnowledge = {
    description: "Indeterminate loading indicator | Circular progress spinner | Asynchronous status feedback",
    stateSpecifications: [
        {
            state: "Active",
    ...
    accessibilitySpec: {
        intro: "Spinners are non-interactive but must communicate loading status to assistive technology users who cannot perceive the visual animation.",
        requirements: [
