...
exports.chipKnowledge = void 0;
exports.chipKnowledge = {
    description: "Compact label | Filterable tag | Dismissible metadata token",
    stateSpecifications: [
        {
            state: "Default",
    ...
    accessibilitySpec: {
        intro: "Chips serve as compact interactive elements that must be fully operable by keyboard and announced correctly by screen readers.",
        requirements: [
