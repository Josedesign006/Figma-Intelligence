...
exports.treeviewKnowledge = void 0;
exports.treeviewKnowledge = {
    description: "Hierarchical expandable tree | Displays nested parent-child relationships | Supports single and multi-selection with full keyboard navigation",
    stateSpecifications: [
        {
            state: "Expanded",
    ...
    accessibilitySpec: {
        intro: "Treeview is one of the most complex ARIA patterns. It requires precise role assignment, keyboard navigation following the WAI-ARIA TreeView pattern, and correct state management for expanded, selected, and disabled nodes.",
        requirements: [
