...
exports.statusDotKnowledge = void 0;
exports.statusDotKnowledge = {
    description: "Simple colored dot indicator | Conveys status at a glance | Paired with text label for accessibility",
    stateSpecifications: [
        {
            state: "Default",
    ...
    accessibilitySpec: {
        intro: "Status dots rely on color to convey meaning, which is invisible to colorblind and screen-reader users. Accessible implementation is non-negotiable.",
        requirements: [
