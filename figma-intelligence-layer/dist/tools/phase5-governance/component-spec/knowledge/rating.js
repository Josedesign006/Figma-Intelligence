...
exports.ratingKnowledge = void 0;
exports.ratingKnowledge = {
    description: "Star-based rating input and display | Supports full and half-star precision | Read-only and interactive modes",
    stateSpecifications: [
        {
            state: "Default",
    ...
    accessibilitySpec: {
        intro: "Rating components must be fully operable via keyboard and correctly announced by screen readers. The star metaphor is visual — assistive tech needs explicit value context.",
        requirements: [
