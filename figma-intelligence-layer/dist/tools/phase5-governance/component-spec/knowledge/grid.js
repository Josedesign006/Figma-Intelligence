...
exports.gridKnowledge = void 0;
exports.gridKnowledge = {
    description: "CSS Grid-based layout container | Structures content in rows and columns | Purely presentational with no interactive states",
    stateSpecifications: [
        {
            state: "Default",
    ...
    accessibilitySpec: {
        intro: "Grid is a purely structural layout component with no interactive role. Accessibility concerns are limited to ensuring the DOM order matches visual order and that grid children are properly accessible.",
        requirements: [
