...
exports.tabsKnowledge = void 0;
exports.tabsKnowledge = {
    description: "Content organizer | Sectioned view switcher | Tabbed navigation pattern",
    stateSpecifications: [
    ...
    accessibilitySpec: {
        intro: "Tabs must implement the WAI-ARIA tabs pattern with proper roles, relationships, and keyboard support. Users must be able to discover and switch between tab panels using keyboard alone.",
        requirements: [
