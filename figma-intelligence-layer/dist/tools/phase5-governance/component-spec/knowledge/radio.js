...
exports.radioKnowledge = void 0;
exports.radioKnowledge = {
    description: "Exclusive selection control | Single choice from group | Mutually exclusive options",
    stateSpecifications: [
    ...
    accessibilitySpec: {
        intro: "Radio groups must be perceivable, operable, and understandable by assistive technology users. The <fieldset>/<legend> pattern ensures screen readers announce the group question.",
        requirements: [
