...
exports.rangeSliderKnowledge = void 0;
exports.rangeSliderKnowledge = {
    description: "Dual-thumb range slider | Min/max value selection | Continuous or stepped range input with two draggable handles",
    stateSpecifications: [
        {
            state: "Default",
    ...
    accessibilitySpec: {
        intro: "Range sliders use two separate slider ARIA roles to enable independent control of min and max values. Each thumb must be independently operable via keyboard with proper value announcements.",
        requirements: [
