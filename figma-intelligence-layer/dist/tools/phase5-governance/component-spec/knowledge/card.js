...
exports.cardKnowledge = void 0;
exports.cardKnowledge = {
    description: "Content container | Grouped information surface | Scannable content unit",
    stateSpecifications: [
    ...
    accessibilitySpec: {
        intro: "Cards must be perceivable as distinct content units and, when interactive, operable via keyboard. Clickable cards require careful handling to avoid nested interactive element issues.",
        requirements: [
