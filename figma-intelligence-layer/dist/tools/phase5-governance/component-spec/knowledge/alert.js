...
exports.alertKnowledge = void 0;
exports.alertKnowledge = {
    description: "Status notification | Inline feedback message | Contextual information banner",
    stateSpecifications: [
        {
            state: "Info",
    ...
    accessibilitySpec: {
        intro: "Alerts must communicate their severity and content to assistive technology. Persistent alerts use role='alert'; status updates use role='status'.",
        requirements: [
