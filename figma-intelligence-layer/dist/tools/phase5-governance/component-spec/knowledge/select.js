...
exports.selectKnowledge = void 0;
exports.selectKnowledge = {
    description: "Option selector | Single or multi-choice picker | Form selection control",
    stateSpecifications: [
        {
            state: "Default",
        ...
        {
            state: "Open",
            visualChange: "Dropdown list is visible below or above the trigger; chevron rotates",
            opacity: "1",
            cursorWeb: "pointer",
        ...
        {
            state: "Disabled",
            visualChange: "Muted colors on trigger, chevron, and text; no pointer events",
            opacity: "0.4",
        ...
        {
            state: "Error",
            visualChange: "Trigger border changes to error color; error message appears below",
            opacity: "1",
            cursorWeb: "pointer",
        ...
        {
            state: "Filled",
            visualChange: "Selected value replaces placeholder text inside the trigger",
            opacity: "1",
            cursorWeb: "pointer",
    ...
    propertyDescriptions: {
        ...
        options: "List of available choices, each with a value and display label",
        ...
        searchable: "Adds a text filter inside the dropdown for long option lists",
        ...
        clearable: "Shows a clear icon inside the trigger to reset the selection",
    },
    sizeSpecifications: [
        {
            size: "Small",
    ...
    responsiveBehaviour: [
        {
            breakpoint: "< 480px",
            behavior: "Trigger stretches to full width; dropdown renders as a bottom sheet or full-width overlay",
        },
        {
            breakpoint: "480px – 1024px",
            behavior: "Trigger follows grid column span; dropdown panel matches trigger width or grows to content",
        },
        {
            breakpoint: "> 1024px",
            behavior: "Trigger may have a constrained max-width; dropdown remains anchored to the trigger edge",
        },
    ],
    accessibilitySpec: {
        intro: "The select must follow the ARIA combobox pattern so assistive technology can announce the role, expanded state, and active option.",
        requirements: [
            {
                requirement: "Trigger has role=\"combobox\" with aria-haspopup=\"listbox\" and aria-expanded reflecting open/closed state",
                level: "A",
                notes: "WCAG 4.1.2 – Name, Role, Value",
            },
            {
                requirement: "The dropdown list has role=\"listbox\" and each option has role=\"option\"",
                level: "A",
                notes: "ARIA listbox pattern",
            },
            {
                requirement: "aria-activedescendant on the trigger points to the id of the currently focused option",
                level: "A",
                notes: "Enables screen readers to track visual focus without moving DOM focus",
            },
            {
                requirement: "Label element is linked to the trigger via htmlFor/id or aria-labelledby",
                level: "A",
                notes: "WCAG 1.3.1 – Info and Relationships",
            },
            {
                requirement: "Focus indicator on the trigger and on individual options meets 3:1 contrast",
                level: "AA",
    ...
    qaAcceptanceCriteria: [
        {
            check: "Open / close",
            platform: "Web / Mobile",
            expectedResult: "Clicking the trigger opens the dropdown; clicking outside or pressing Escape closes it",
        },
        {
            check: "Keyboard navigation",
            platform: "Web",
            expectedResult: "Arrow keys move focus through options; Enter selects; Home/End jump to first/last option",
        },
        {
            check: "Search filtering",
            platform: "Web",
            expectedResult: "Typing in the search field filters options in real time; no-match state shows an empty message",
        },
        {
            check: "Multi-select",
            platform: "Web / Mobile",
            expectedResult: "Checking multiple options adds chips to the trigger; each chip has a remove button",
        },
        {
            check: "Scroll behavior",
            platform: "Web / Mobile",
            expectedResult: "Long option lists scroll within the dropdown; focused option is always scrolled into view",
        },
        {
            check: "Screen reader announcement",
            platform: "Web",
            expectedResult: "VoiceOver/NVDA reads label, role, expanded state, option count, and selected option",
        },
    ],
    dos: [
