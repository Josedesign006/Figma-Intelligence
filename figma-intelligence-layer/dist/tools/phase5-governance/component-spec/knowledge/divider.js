...
exports.dividerKnowledge = void 0;
exports.dividerKnowledge = {
    description: "Horizontal or vertical separator line | Visually divides content sections | Supports solid, dashed, and labeled variants",
    stateSpecifications: [
        {
            state: "Default",
    ...
    accessibilitySpec: {
        intro: "Dividers can be semantic (representing a thematic content break) or decorative (purely visual). The correct ARIA treatment depends on the divider's purpose in context.",
        requirements: [
