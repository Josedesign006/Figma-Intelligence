...
exports.linkKnowledge = void 0;
exports.linkKnowledge = {
    description: "Navigational text element | Inline anchor | Standalone hyperlink — distinct from Button",
    stateSpecifications: [
        {
            state: "Default",
    ...
    accessibilitySpec: {
        intro: "Links must use native <a> elements with descriptive text, proper focus management, and clear indication of navigation behavior.",
        requirements: [
