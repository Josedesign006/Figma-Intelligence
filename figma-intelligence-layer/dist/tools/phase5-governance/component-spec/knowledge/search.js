...
exports.searchKnowledge = {
    description: "Search input with clear and results | Filters content in real-time | Supports debounce, suggestions, and loading states",
    stateSpecifications: [
        {
            state: "Default",
    ...
    accessibilitySpec: {
        intro: "Search inputs must be discoverable and operable for all users. Proper ARIA roles, autocomplete semantics, and keyboard navigation are essential for suggestion dropdowns.",
        requirements: [
