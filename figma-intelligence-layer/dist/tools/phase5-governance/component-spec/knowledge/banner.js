...
exports.bannerKnowledge = void 0;
exports.bannerKnowledge = {
    description: "Full-width persistent notification bar | Communicates system-level messages | Pinned to top, bottom, or inline position",
    stateSpecifications: [
        {
            state: "Default",
    ...
    accessibilitySpec: {
        intro: "Banners are system-level notifications that must be announced to assistive technologies appropriately based on their urgency level. Error and warning banners use role='alert' for assertive announcement; info and success use role='status' for polite announcement.",
        requirements: [
