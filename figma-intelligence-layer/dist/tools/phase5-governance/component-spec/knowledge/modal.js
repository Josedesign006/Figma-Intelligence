...
exports.modalKnowledge = void 0;
exports.modalKnowledge = {
    description: "Overlay dialog | Focused interaction container | Content interruption layer",
    stateSpecifications: [
    ...
    accessibilitySpec: {
        intro: "Modals must trap focus, lock background scrolling, and announce their purpose to assistive technologies. They represent a critical interruption pattern that must be fully keyboard operable.",
        requirements: [
