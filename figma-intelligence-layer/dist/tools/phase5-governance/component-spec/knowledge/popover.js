...
exports.popoverKnowledge = void 0;
exports.popoverKnowledge = {
    description: "Interactive floating panel | Triggered by click | Displays rich content in context",
    stateSpecifications: [
        {
            state: "Closed",
    ...
    accessibilitySpec: {
        intro: "Popovers contain interactive content and must implement a full dialog-like accessibility pattern with focus management and keyboard dismissal.",
        requirements: [
