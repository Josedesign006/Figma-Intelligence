...
exports.segmentedControlKnowledge = void 0;
exports.segmentedControlKnowledge = {
    description: "Mutually exclusive button group | Single-selection control | Inline view switcher or filter toggle",
    stateSpecifications: [
        {
            state: "Default",
    ...
    accessibilitySpec: {
        intro: "Segmented controls function as single-selection radio groups. Proper ARIA roles and keyboard navigation patterns are critical for screen reader and keyboard-only users.",
        requirements: [
