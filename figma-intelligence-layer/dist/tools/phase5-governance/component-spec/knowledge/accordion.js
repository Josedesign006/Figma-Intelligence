...
exports.accordionKnowledge = void 0;
exports.accordionKnowledge = {
    description: "Expandable content panel | Progressive disclosure control | Collapsible section container",
    stateSpecifications: [
        {
            state: "Collapsed",
    ...
    accessibilitySpec: {
        intro: "Accordions rely on the disclosure pattern (heading + region) to be accessible. Proper ARIA roles and keyboard support are essential.",
        requirements: [
