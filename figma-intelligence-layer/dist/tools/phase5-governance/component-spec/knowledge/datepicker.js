...
exports.datepickerKnowledge = void 0;
exports.datepickerKnowledge = {
    description: "Date selection compound component | Input trigger with calendar popup | Supports single date and date range selection",
    stateSpecifications: [
        {
            state: "Default",
    ...
    accessibilitySpec: {
        intro: "Date pickers are complex widgets requiring careful ARIA markup and full keyboard navigation to be usable by screen reader and keyboard-only users.",
        requirements: [
