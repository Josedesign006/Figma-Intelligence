...
exports.inputKnowledge = void 0;
exports.inputKnowledge = {
    description: "Text entry field | Captures user input | Form data collection element",
    stateSpecifications: [
        {
            state: "Default",
        ...
        {
            state: "Error",
            visualChange: "Border turns error color, error message appears below field",
            opacity: "1",
            cursorWeb: "text",
        ...
        {
            state: "Read-only",
            visualChange: "Value is visible but field chrome is reduced; no editable caret",
            opacity: "1",
            cursorWeb: "default",
    ...
    propertyDescriptions: {
        ...
        helperText: "Supplementary guidance displayed below the field (e.g. format hint)",
        ...
        suffix: "Static content rendered inside the field after the value (e.g. kg)",
    ...
    interactionRules: [
        ...
        },
        {
            ...
            action: "Characters are inserted at the caret position; value updates in real time",
        },
        {
            event: "blur",
            trigger: "Field loses focus (user clicks elsewhere or tabs away)",
            action: "Validation fires; error state is applied if the value is invalid",
        },
        {
            event: "click (clear)",
            trigger: "User clicks the clear button inside the field",
            action: "Value is emptied, field retains focus, and onChange callback fires",
        },
    ],
    contentGuidance: [
    ...
    responsiveBehaviour: [
        {
            breakpoint: "< 480px",
            behavior: "Field stretches to full container width; label stacks above the field",
        },
        {
            breakpoint: "480px – 1024px",
            behavior: "Field width follows the grid column span; side-by-side labels are acceptable",
        },
        {
            breakpoint: "> 1024px",
            behavior: "Field width may be constrained to a max-width for readability; inline labels permitted",
        },
    ],
    accessibilitySpec: {
        intro: "The text input must be operable via keyboard and correctly announce its label, state, and errors to assistive technology.",
        requirements: [
            {
                requirement: "Field has role=\"textbox\" (implicit via <input>) and a visible <label> element linked by htmlFor/id",
                level: "A",
                notes: "WCAG 1.3.1 – Info and Relationships",
            },
            {
                requirement: "When the field is required, aria-required=\"true\" is set and the label includes a visual required indicator",
                level: "A",
                notes: "WCAG 3.3.2 – Labels or Instructions",
            },
            {
                requirement: "When validation fails, aria-invalid=\"true\" is set on the input",
                level: "A",
                notes: "WCAG 3.3.1 – Error Identification",
            },
            {
                requirement: "Error message element is linked to the input via aria-describedby so screen readers announce the error on focus",
                level: "A",
                notes: "WCAG 3.3.1 – Error Identification",
            },
            {
                requirement: "Text and border meet WCAG AA contrast ratio (4.5:1 for text, 3:1 for non-text UI)",
                level: "AA",
                notes: "WCAG 1.4.3 / 1.4.11",
            },
            {
                requirement: "Focus indicator is visible with at least 3:1 contrast against adjacent colors",
                level: "AA",
    ...
    qaAcceptanceCriteria: [
        {
            ...
            platform: "Web / Mobile",
            expectedResult: "Clicking or tapping the field shows a visible focus ring and text caret",
        },
        {
            check: "Validation on blur",
            platform: "Web",
            expectedResult: "Leaving an invalid required field displays the error message and sets the error border",
        },
        {
            check: "Character count",
            platform: "Web / Mobile",
            expectedResult: "When maxLength is set, the user cannot type beyond the limit and a counter is displayed",
        },
        {
            check: "Paste handling",
            platform: "Web",
            expectedResult: "Pasting text that exceeds maxLength truncates to the limit; value updates correctly",
        },
        {
            check: "RTL support",
            platform: "Web",
            expectedResult: "In RTL locales the label, value, and helper text are right-aligned; prefix/suffix positions are mirrored",
        },
        {
            check: "Screen reader announcement",
            platform: "Web",
            expectedResult: "VoiceOver/NVDA reads: label, required status, current value, and any error message on focus",
        },
    ],
    dos: [
