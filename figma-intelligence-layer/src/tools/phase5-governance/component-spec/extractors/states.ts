/**
 * Deterministic state extraction — detects states from variant properties
 */
import type { NodeSnapshot, StatesExtraction, DetectedState } from "../types.js";

export function extractStates(snapshot: NodeSnapshot): StatesExtraction {
  const states: DetectedState[] = [];
  let stateAxisName: string | null = null;
