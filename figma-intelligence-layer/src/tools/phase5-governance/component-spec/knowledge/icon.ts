...
export const iconKnowledge: ComponentKnowledge = {
  ...
  interactionRules: [
    ...
    { event: "Parent Disabled", trigger: "Parent sets disabled state", action: "Icon color transitions to $icon-color-disabled with opacity 0.4" },
